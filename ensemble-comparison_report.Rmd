...
wis_date_plot_us1_2223 <- flu_date_horizon_season_us |>
  dplyr::filter(season == "2022-2023") |>
  plot_evaluated_scores_forecast_date(model_names, model_colors, h=1, main="US, 1 week ahead")
wis_date_plot_us4_2223 <- flu_date_horizon_season_us |>
  dplyr::filter(season == "2022-2023") |>
  plot_evaluated_scores_forecast_date(model_names, model_colors, h=4, main="US, 4 week ahead")
...
```{r by location and season, message=FALSE, warning=FALSE, fig.cap=''}  
...
wis_loc_plot_2122 + wis_loc_plot_2223 +
  plot_layout(ncol = 2, guides='collect') &
  theme(legend.position='bottom')
```


```{r by location and horizon, message=FALSE, warning=FALSE, fig.cap=''}  
...
wis_loc_plot1 + wis_loc_plot4 +
  plot_layout(ncol = 2, guides='collect') &
  theme(legend.position='bottom')
```


```{r by location, horizon, and season, message=FALSE, warning=FALSE, fig.cap=''}  
...
wis_loc_plot4_2122 <- flu_scores_all |>
  ...
  plot_wis_loc(flu_truth_21_22, model_levels_horizon4_2122, baseline_name = "Flusight-baseline")
...
wis_loc_plot1_2122 + wis_loc_plot4_2122 + 
  plot_layout(ncol = 2, guides='collect') &
  theme(legend.position='bottom')
  
wis_loc_plot1_2223 + wis_loc_plot4_2223 +
  plot_layout(ncol = 2, guides='collect') &
  theme(legend.position='bottom')
```
